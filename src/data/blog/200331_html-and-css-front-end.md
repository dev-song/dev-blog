...
- 레이아웃: HTML 화면의 기본적 구성 요소
  ...
  - ![의미론적으로 구성된 HTML 레이아웃](./images/13-0.png)
...
- 웹사이트의 구조에 맞는 태그를 계층적으로 설계하는 것
  - ![표준 페이지 디자인과 주요 구성요소](./images/13-1.png)
...
- 예외
  ...
  - CSS의 C, Cascading의 의미
    ...
    - ![CSS 선택자들의 우선순위가 결정되는 방식](./images/13-2.png)
...
- 선택자의 종류
  - | **선택자**      | **tag**                | **class**                      | **id**                      |
    | --------------- | ---------------------- | ------------------------------ | --------------------------- |
    | HTML에서의 표현 | <tag>                  | <tag class="class\_name">      | <tag id="id\_name">         |
    | CSS에서의 호출  | tag {property: value;} | .class_name {property: value;} | #id_name {property: value;} |
