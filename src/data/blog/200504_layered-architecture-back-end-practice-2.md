...
> → LogDao 클래스 생성
> ![](./images/76-2.png)
> ([Spring JDBC (Back End) ... Part 4](https://til-devsong.tistory.com/58) RoleDao 클래스 수정 참고)
> → @Repository 입력  
...
> 프로젝트 > Java Resources > src/main/java > kr.or.connect.guestbook.dao 우클릭  
> → GuestbookDaoSqls 클래스 생성
> ![](./images/76-3.png)
> ([Spring JDBC (Back End) ... Part 3](https://til-devsong.tistory.com/55?category=772389) RoleDaoSqls 클래스 생성 참고)  
...
> 프로젝트 > Java Resources > src/main/java > kr.or.connect.guestbook.dao 우클릭  
> → GuestbookDaoTest 클래스 생성
> ![](./images/76-5.png)
> ([Spring JDBC (Back End) ... Part 3](https://til-devsong.tistory.com/55?category=772389) SELECT 쿼리문 실행 테스트하기 참고)   
